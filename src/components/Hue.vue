<template lang="pug">
.sketch-color-picker--c-hue(:class="directionClass")
	.sketch-color-picker--c-hue--container(v-el:container
	@mousedown="handleMouseDown",
	@touchmove="handleChange",
	@touchstart="handleChange")
		.sketch-color-picker--c-hue--pointer(:style="{top: pointerTop, left: pointerLeft}")
			slot
				.sketch-color-picker--c-hue--picker
</template>
